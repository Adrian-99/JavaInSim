...
/**
 * This class holds information about car tyres. In {@link pl.adrian.api.insim.packets.NplPacket NplPacket} those are
 * types of tyres that player's car is equipped with. In {@link pl.adrian.api.insim.packets.PitPacket PitPacket} those
