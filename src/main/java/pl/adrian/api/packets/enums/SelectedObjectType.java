...
/**
 * Enumeration for selected object types used in {@link pl.adrian.api.packets.CimPacket CimPacket}.
 */
public enum SelectedObjectType implements EnumWithCustomValue {
    /**
     * value 0: no object selected
     */
    NULL(0),
    /**
     * value 4: chalk line
     ...
     * @return enum value
     */
    public static SelectedObjectType fromOrdinal(int ordinal) {
        return EnumHelpers.get(SelectedObjectType.class).fromOrdinal(ordinal);
    }
}
