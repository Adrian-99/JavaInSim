...
import pl.adrian.api.packets.structures.CompCar;
 ...
 * 2) Set flag {@link pl.adrian.api.packets.flags.IsiFlag#MCI Isi MCI} in the {@link IsiPacket}.
 */
public class MciPacket extends Packet implements RequestablePacket {
     ...
     * @param reqI 0 unless this is a reply to an {@link pl.adrian.api.packets.enums.TinySubtype#MCI Tiny MCI} request
