...
/**
 * Flags used in {@link SmallSubtypes#LCS} {@link SmallPacket SmallPacket}.
 */
public enum LcsFlag implements FlagWithCustomValue {
    /**
     * signals off
     * @deprecated {@link SmallSubtypes#LCL} {@link SmallPacket SmallPacket} should be used instead
     */
    @Deprecated
    SIGNALS_OFF(1, 769),
    /**
