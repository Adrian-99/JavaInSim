...
class PacketValidatorTest {
    ...
    void validate_withTooLowShortByte() {
        ...
        Assertions.assertEquals(ValidationFailureCategory.VALUE_OUT_OF_RANGE, exception.getFailureCategory());
    ...
    void validate_withTooLongByteArray() {
        ...
        var exception = assertThrows(PacketValidationException.class, () -> PacketValidator.validate(packet));
        Assertions.assertEquals(ValidationFailureCategory.INCORRECT_VALUE_LENGTH, exception.getFailureCategory());
    ...
    void validate_packetWithFieldWithoutAnnotation() {
        ...
        var exception = assertThrows(PacketValidationException.class, () -> PacketValidator.validate(packet));
        Assertions.assertEquals(ValidationFailureCategory.INCORRECT_TYPE_ANNOTATION, exception.getFailureCategory());
    ...
    void validate_packetWithInvalidByteType() {
        ...
        var exception = assertThrows(PacketValidationException.class, () -> PacketValidator.validate(packet));
        Assertions.assertEquals(ValidationFailureCategory.UNSUPPORTED_TYPE, exception.getFailureCategory());
    ...
    private static class ValidTestPacket extends AbstractPacket implements InstructionPacket {
        ...
        @com.github.adrian99.javainsim.internal.insim.packets.annotations.Float(minValue = -5.0f, maxValue = 15.0f)
